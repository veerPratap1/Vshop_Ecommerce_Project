...
import { createMessageAsync } from "../Contact/ContactSlice";
...
export default function Contact() {
  ...
  return (
    <>
      {
        <section className="flex items-center bg-gradient-to-r from-gray-50 to-orange-50 xl:h-screen font-poppins dark:from-gray-900 dark:to-gray-900 ">
            ...
            <div className="flex flex-wrap items-center justify-center -mx-4">
                ...
                <div className="max-w-sm mx-auto ">
                  <div className="p-6 mb-6 text-center bg-white border rounded-md shadow dark:border-gray-800 dark:bg-gray-800">
                    <form onSubmit={handleSubmit(onSubmit)}>
                      ...
                      <button className="w-full py-4 text-sm font-bold leading-normal text-white transition-all duration-300 bg-orange-600 rounded-md dark:bg-orange-500 dark:hover:bg-orange-600 hover:bg-orange-700">
                        Send Message
                      </button>
                    </form>
                  </div>
              ...
              <div className="max-w-2xl px-4 mb-16 lg:mb-0 lg:w-1/2 lg:mr-0 lg:ml-auto">
                ...
                <div className="flex mb-6 text-gray-400 dark:text-gray-400">
                  ...
                  <div className="max-w-xl ml-4 text-lg font-semibold tracking-wide text-gray-500 dark:text-gray-400">
                    <span> +91-9896080492 ,</span> <span> +91-7206613057</span>
                  </div>
                </div>
