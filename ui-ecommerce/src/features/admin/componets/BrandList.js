...
const BrandList = () => {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(updateBrandAsync(item));
    if(status === "idle"){
      alert.success("Brand is Successfully Updated")
    }
    reset();
  };
                          ...
                          <tr role="row" key={index}>
                            ...
                            <td className="py-3 text-sm" role="cell">
                              <div className="flex font-bold justify-center">
                                <Modal
                                  title={`${Brand.label}`}
                                  message="Do You Want To Delete This Brand From List ?"
                                  cancelOption="Cancel"
                                  dangerOption="Remove"
                                  dangerAction={(e) =>
